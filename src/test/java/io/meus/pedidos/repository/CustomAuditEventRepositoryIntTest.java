package io.meus.pedidos.repository;

import io.meus.pedidos.MeusPedidosApp;
import io.meus.pedidos.config.Constants;
import io.meus.pedidos.config.audit.AuditEventConverter;
import io.meus.pedidos.domain.PersistentAuditEvent;
...
import static io.meus.pedidos.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
