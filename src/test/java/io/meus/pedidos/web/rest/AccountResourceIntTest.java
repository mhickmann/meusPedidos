package io.meus.pedidos.web.rest;
import io.meus.pedidos.config.Constants;

import io.meus.pedidos.MeusPedidosApp;
import io.meus.pedidos.domain.Authority;
import io.meus.pedidos.domain.User;
import io.meus.pedidos.repository.AuthorityRepository;
import io.meus.pedidos.repository.UserRepository;
import io.meus.pedidos.security.AuthoritiesConstants;
import io.meus.pedidos.service.MailService;
import io.meus.pedidos.service.UserService;
import io.meus.pedidos.service.dto.UserDTO;
import io.meus.pedidos.web.rest.vm.KeyAndPasswordVM;
import io.meus.pedidos.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = MeusPedidosApp.class)
